...
def set_debug_mode(cfg, args):
    ...
    if args.server == 'local':
        ...
        if args.mode == 'linear_probing':
            cfg['dataset_eval']['batch_size'] = 4
            cfg['dataset_eval']['test']['clips_per_video']=2
            cfg['dataset_eval']['base']['clips_per_video']=2
            # cfg['eval']['linear']['kwargs']['optimizer']['num_epochs'] = 4
        else:
        ...
        # if args.sub_dir=='pretext':
        #     cfg['dataset_eval']['batch_size'] = 4
        #     cfg['dataset_eval']['test']['clips_per_video']=2
        #     cfg['dataset_eval']['base']['clips_per_video']=2
        #     cfg['eval']['linear']['kwargs']['optimizer']['epochs']=2

    
    cfg['progress']['print_freq'] = 1
    try:
        # cfg['eval']['knn']['knn_monitor']=True
        cfg['eval']['linear']['interval']=1
    except:
        pass
